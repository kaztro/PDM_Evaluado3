...
import com.example.evllab3.recyclerview.MovieAdapter
...
class MainListFragment: Fragment(){
    ...
    override fun onAttach(context: Context) {
        ...
        if (context is ClickedMovieListener) {
            ...
            throw RuntimeException("No Interface Implementation")
        }
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val view = inflater.inflate(com.example.evllab3.R.layout.movie_list_fragment, container, false)
